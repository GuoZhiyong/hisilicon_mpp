...
HI_S32 Setconfiginfo(HI_HANDLE chnHandle, HI_UNF_CIPHER_KEY_SRC_E enKeySrc, 
...
HI_VOID CBC_AES128(HI_VOID)
{
    ...
    s32Ret = Setconfiginfo(hTestchnid, 
                            ...
                            aes_key, aes_IV, HI_NULL, HI_NULL);
	if(HI_SUCCESS != s32Ret)
	{
